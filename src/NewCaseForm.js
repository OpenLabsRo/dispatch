...
const NewCaseForm = () => {
    ...
    const [ambulances] = useState([
        ...
        { id: 2, status: 'busy', coordinates: [26.1050, 44.4280] },
    ]);
    ...
    useEffect(() => {
        if (!geocoderRef.current) {
            geocoderRef.current = new MapboxGeocoder({
                ...
                bbox: [20.2000, 44.0000, 30.5000, 48.5000] // Bounding box to narrow the search to Romania
            });
    ...
    const calculateBirthdate = (cnp) => {
        ...
        const year = cnp[0] === '1' || cnp[0] === '2' ? '19' + cnp.slice(1, 3) : '20' + cnp.slice(1, 3);
    ...
    useEffect(() => {
        if (showAmbulancePopup) {
            ...
            ambulances.forEach((ambulance) => {
                new mapboxgl.Marker({ color: ambulance.status === 'available' ? 'green' : 'red' })
        ...
        <div className="form-page">
            ...
            <form onSubmit={handleSubmit} className="case-form">
                ...
                <div className="selected-ambulance">
                    Selected Ambulance: {selectedAmbulance ? `Ambulance ${selectedAmbulance.id}` : 'None'}
                </div>
            ...
            {showAmbulancePopup && (
                <div className="popup">
                    <div className="popup-content">
                        <button className="close-btn" onClick={() => setShowAmbulancePopup(false)}>X</button>
